...
export class Game {
    public bga: Bga<TtegglitTutorialReversiPlayer, TtegglitTutorialReversiGamedatas>;
    private gamedatas: TtegglitTutorialReversiGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<TtegglitTutorialReversiPlayer, TtegglitTutorialReversiGamedatas>) {
        console.log('ttegglittutorialreversi constructor');
        this.bga = bga;
    ...
    */
    ...
    setup(gamedatas: TtegglitTutorialReversiGamedatas) {
