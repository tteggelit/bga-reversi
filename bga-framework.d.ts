...
declare class Display3D {
   ...
   */
  setDraggable(
    enabled?: boolean | number | Display3DDraggableSettings,
    settings?: number | Display3DDraggableSettings,
  ): void;
   ...
   */
  setZoomByWheel(
    enabled?: boolean | number | Display3DZoomByWheelSettings,
    settings?: number | Display3DZoomByWheelSettings,
  ): void;
...
interface Bga<
  ...
  G extends Gamedatas<P> = Gamedatas<P>,
> {
  gameui: GameGui<P, G>;
  display3D: Display3D;
  statusBar: StatusBar;
